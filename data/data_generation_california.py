...
class DatasetGenerator:
    ...
    def read_polygon_file(self, polygon_file):
        ...
        # print("test\n")    
        # print(polygon_data.keys())
        self.polygon_data = polygon_data["features"]
        # print(polygon_data[0].keys)
    ...
    def get_sample_bounds(self, centroid, image=None, image_size=None):
        """Retruns the bounds of an image sample.
...
def main():
    with open("datagen_config_california.json", mode="r") as f:
        args = json.load(f)
